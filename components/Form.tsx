...
const Form = ({ type, prompt, setPrompt, submitting, handleSubmit }: FormProps) => {
  return (
    <section className="w-full max-w-full flex flex-col items-center">
      ...
      >
        <label>
          ...
          <textarea
            value={prompt?.post}
            onChange={(e) => setPrompt({ ...prompt, post: e.target.value })}
        ...
        <div className="flex-end flex justify-between items-center mx-3 mb-5 gap-4">
